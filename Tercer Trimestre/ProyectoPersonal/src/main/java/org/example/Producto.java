...
public class Producto implements Serializable {
    ...
    public Producto(String ref, String nombre, String descripcion, int tipo,
                    int cantidad, double precio, int descuento, int iva, boolean aplicarDto) {
        ...
        this.id = Gestion.generarIdJuego();
        this.ref = ref;
        this.nombre = nombre;
        this.descripcion = (descripcion == null || descripcion.isEmpty()) ? DESC_VACIA : descripcion;
        this.tipo = tipo;
    ...
    public String toString() {
        return String.format("Ref: %-10s | Nombre: %-20s | Stock: %d | Precio: %.0f€",
