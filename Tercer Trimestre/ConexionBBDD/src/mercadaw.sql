...
('M002', 'Plátanos', 'Plátanos de Canarias', 1, 40, 1.10, 0, 4, false),
...
('M010', 'Carne de ternera', 'Filetes de ternera', 3, 15, 12.00, 5, 10, true),
('M011', 'Carne de cerdo', 'Chuletas de cerdo', 3, 18, 6.80, 0, 10, false),
...
('M018', 'Croissant', 'Croissant de mantequilla', 6, 40, 1.20, 5, 4, true),
